...
<body ng-controller="adminViewReportController">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li ><a href="adminScreen.php" style="color:white">Home <span class="sr-only">(current)</span></a></li>
        <li><a href="#"></a></li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color:white;font-size:2em">Admin Report View </a>
        </li>
      </ul>
...
<div class="col-md-8"> 
<div id="exportable">
        <div class="col-md-9 " style="text-align: center;"> All Users Admin Report</div> 
            <table class="table export-table table-bordered  header-fixed">
              <thead>
                 <tr>
                     ...
                     <th>Gender</th> 
                     <th>Reg Date</th> 
                     <th>last Used System</th>
                     <th>Role</th>                    
                 </tr>
               </thead>
               <tbody>
                <tr ng-repeat="detail in allLetters">
                   <td>{{detail.user_surname}} {{detail.user_name}} </td>
                   <td>{{detail.date_of_birth}}</td>
                   <td>{{detail.user_cellphone}} {{detail.user_email}}</td>
                   <td>{{detail.gender}}</td>
                   <td>{{detail.created_date}}</td>
                   <td>{{detail.last_loggin}}</td>
   ...
   <button type="button"  value="submit" class="btn btn-primary" ng-click="eAction(selectedExport)">Export</button>
    ...
    <script src="js/base64.js" type="text/javascript"></script> 
      <!-- Load controllers -->
   <script src="angular/adminViewReportController.js" type="text/javascript"></script>   
